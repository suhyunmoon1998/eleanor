...
export class AIService {
  ...
  private buildFinalReportInstructions() {
    return [
      ...
      "When a correction is high-confidence, write the corrected intended meaning in the answer. When it is uncertain, mark it as 미확인 / Not confirmed and place the unresolved phrase in openQuestions.",
